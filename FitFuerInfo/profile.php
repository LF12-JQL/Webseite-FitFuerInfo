...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    } elseif ($_POST['action'] === 'change_password_admin') {
        if ($user['role'] === 'Systemverwalter') {
            $password = $_POST['new_password'];
            $password_confirm = $_POST['new_password_confirm'];
...
<div class="card">
    ...
    <?php if ($user['role'] === 'Systemverwalter'): ?>
        <p>Als Systemverwalter können Sie Ihr Passwort direkt ändern.</p>
